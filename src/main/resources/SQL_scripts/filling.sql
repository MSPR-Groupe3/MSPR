...
INSERT INTO `organization` (`company_name`, `street_address1`, `street_address2`, `street_address3`, `city_name`, `postal_code`, `country`, `phone_number`, `email`) VALUES
...
INSERT INTO `product` (`name`, `reference`, `description`, `unit_price_before_tax`, `tax_rate`, `quantity_available`, `is_sellable`) VALUES
...
INSERT INTO `purchase` (`reference`, `date_of_order`, `comment`) VALUES
